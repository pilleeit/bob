<x-layout>
  <form method="POST" action="/ideas/{{ $idea->id }}">
    ...
    <div class="mt-6 flex items-center gap-x-2">
      <button type="submit" class="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white shadow-sm">Update</button>
          
      <button type="submit" 
        form="delete-idea-form"
        class="rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-white shadow-sm">
        Delete</button>
    </div>
